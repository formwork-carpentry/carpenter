...
The following table shows the currently supported versions of Carpenter:
...
The Carpenter team takes security very seriously. If you discover a security vulnerability in Carpenter, please report it responsibly by following these steps:
...
2. Report the vulnerability using GitHub's **private vulnerability disclosure feature**:
   - Navigate to https://github.com/formwork-carpentry/carpenter/security/advisories/new
...
When using Carpenter, we recommend:

1. Keep your Node.js version up to date
2. Regularly update Carpenter and its dependencies
...
Thank you for helping keep Carpenter secure!
